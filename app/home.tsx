...
const QUICK_ACTIONS = [
  {
    ...
    color: "#2E7D32",
    gradient: ["#d2ffa0", "#2E7D32"] as [string, string],
  },
  {
    ...
    color: "#1976D2",
    gradient: ["#5281cd", "#1976D2"] as [string, string],
  },
  {
    ...
    color: "#fee067",
    gradient: ["#E91E63", "#fee067"] as [string, string],
  },
  {
...
export default function HomeScreen() {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <LinearGradient colors={["#d3f1f2", "#64c1c4"]} style={styles.header}>
        <View style={styles.headerContent}>
          <View style={styles.headerTop}>
            <View style={styles.flex1}>
              <Text style={styles.greeting}>Progreso</Text>
            </View>
            <TouchableOpacity

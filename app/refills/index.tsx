...
export default function RefillTrackerScreen() {
  ...
  const handleRefill = async (medication: Medication) => {
    try {
      ...
      Alert.alert(
        "La Recarga",
        `${medication.name} se ha rellenado a ${medication.totalSupply} unidades.`
      );
    } catch (error) {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Seguimiento Recargas</Text>
        </View>
        ...
        >
          {medications.length === 0 ? (
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyStateText}>No hay medicamentos que rastrear</Text>
              <TouchableOpacity
                ...
                <View key={medication.id} style={styles.medicationCard}>
                  ...
                  <View style={styles.supplyContainer}>
                    ...
                    <View style={styles.refillInfo}>
                      ...
                      Recarga en: {medication.refillAt}%
                      </Text>
                  ...
                  >
                    <Text style={styles.refillButtonText}>Recargar</Text>
                  </TouchableOpacity>
                </View>
              );
            })

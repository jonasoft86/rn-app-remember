...
const FREQUENCIES = [
  ...
  {
    id: "3",
    label: "Tres veces al día",
    icon: "time-outline" as const,
    times: ["09:00", "15:00", "21:00"],
  },
  {
    id: "4",
    label: "Cuatro veces al día",
    icon: "repeat-outline" as const,
    times: ["09:00", "13:00", "17:00", "21:00"],
  },
  { id: "5", label: "Según sea necesario", icon: "calendar-outline" as const, times: [] },
];
...
export default function AddMedicationScreen() {
  ...
  const validateForm = () => {
    ...
    if (!form.dosage.trim()) {
      newErrors.dosage = "Se requiere dosis";
    }

    if (!form.frequency) {
      newErrors.frequency = "Se requiere frecuencia";
    }

    if (!form.duration) {
      newErrors.duration = "Se requiere duración";
    }

    if (form.refillReminder) {
      if (!form.currentSupply) {
        newErrors.currentSupply =
          "Se requiere suministro actual para el seguimiento de recargas";
      }
      if (!form.refillAt) {
        newErrors.refillAt = "Se requiere un umbral de alerta de recarga";
      }
      if (Number(form.refillAt) >= Number(form.currentSupply)) {
        newErrors.refillAt = "La alerta de recarga debe ser menor que el suministro actual";
      }
    }
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.header}>
          ...
          >
            <Ionicons name="chevron-back" size={28} color="#64c1c4" />
          </TouchableOpacity>
          ...
          <View style={styles.section}>
            ...
            >
              <View style={styles.dateIconContainer}>
                <Ionicons name="calendar" size={20} color="#64c1c4" />
              </View>
                ...
                {form.times.map((time, index) => (
                  ...
                  >
                    <View style={styles.timeIconContainer}>
                      <Ionicons name="time-outline" size={20} color="#64c1c4" />
                    </View>
              ...
              <View style={styles.switchRow}>
                <View style={styles.switchLabelContainer}>
                  <View style={styles.iconContainer}>
                    <Ionicons name="notifications" size={20} color="#64c1c4" />
                  </View>
                  <View>
                ...
                <Switch
                  ...
                  trackColor={{ false: "#ddd", true: "#64c1c4" }}
                  thumbColor="white"
                />
              </View>
            </View>
          ...
          <View style={styles.section}>
            <View style={styles.card}>
              <View style={styles.switchRow}>
                <View style={styles.switchLabelContainer}>
                  <View style={styles.iconContainer}>
                    <Ionicons name="reload" size={20} color="#64c1c4" />
                  </View>
                  <View>
                    <Text style={styles.switchLabel}>Seguimiento de recargas</Text>
                    <Text style={styles.switchSubLabel}>
          ...
          >
            ...
            >
              <Text style={styles.saveButtonText}>
                {isSubmitting ? "Adding..." : "Agregar Medicamento"}
              </Text>
            </LinearGradient>
          </TouchableOpacity>
          <TouchableOpacity
